...
export function InstagramModal({ isOpen, onClose, editingPost, onSave }: InstagramModalProps) {
  ...
  useEffect(() => {
    if (editingPost) {
      ...
      setFormData({ image: '', caption: '', link: '' });
      setImagePreview('');
    }
  }, [editingPost]);
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const post: InstagramPost = editingPost
        ...
        >
          <div className="sticky top-0 bg-gradient-to-r from-purple-500 to-pink-500 p-6 flex items-center justify-between z-10">
            <h3 className="text-2xl font-serif text-white flex items-center gap-2">
              ...
              {editingPost ? 'Editar Post' : 'Nuevo Post de Instagram'}
            </h3>
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-4">
            <div>
              ...
              <div className="space-y-3">
                ...
                <div
                  ...
                  tabIndex={0}
                  className="border-2 border-dashed border-purple-400 rounded-lg p-8 text-center cursor-pointer hover:border-pink-500 hover:bg-purple-50/50 transition-all"
                >
                ...
                <div className="relative">
                  ...
                  <label
                    ...
                    className={`block w-full px-4 py-4 border-2 border-purple-400 rounded-lg text-center cursor-pointer hover:border-pink-500 hover:bg-purple-50/50 transition-all ${
                ...
                <div>
                  <input
                    ...
                    className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-400 focus:border-transparent outline-none text-sm"
                  />
                </div>
              </div>
              ...
              <div className="mt-3 bg-purple-50 border border-purple-200 rounded-lg p-3">
                <p className="text-xs text-purple-800">
                  ...
                  pegarla directamente haciendo clic en el área morada y presionando Ctrl+V.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-3 pt-4 sticky bottom-0 bg-white pb-2">
              ...
              <button
                type="submit"
                className="flex-1 flex items-center justify-center gap-2 bg-gradient-to-r from-purple-500 to-pink-500 text-white px-6 py-3 rounded-lg hover:shadow-lg transition-all font-medium"
              >
